...
class EndpointAnalysis:
    ...
    def boxplot_ivim_n_in_tnm(self):
        ...
        ax00 = sns.boxplot(ax=axes[0, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_conv", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax01 = sns.boxplot(ax=axes[0, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_seg", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax02 = sns.boxplot(ax=axes[0, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_net", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_conv", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax00)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_seg", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax01)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_net", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax02)

        ax10 = sns.boxplot(ax=axes[1, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_conv", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax11 = sns.boxplot(ax=axes[1, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_seg", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax12 = sns.boxplot(ax=axes[1, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_net", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_conv", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax10)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_seg", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax11)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_net", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax12)

        ax20 = sns.boxplot(ax=axes[2, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_conv", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax21 = sns.boxplot(ax=axes[2, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_seg", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax22 = sns.boxplot(ax=axes[2, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_net", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_conv", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax20)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_seg", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax21)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_net", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax22)
    ...
    def boxplot_adc_n_in_tnm(self):
        ...
        ax = sns.boxplot(ax=ax, data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="ADC", hue="HPV", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="ADC", hue="HPV", order=['N0', 'N1', 'N2'], dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax)
    ...
    def boxplot_ivim_hpv(self):
        ...
        ax00 = sns.boxplot(ax=axes[0, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dt_conv", showfliers=showfliers, boxprops=boxprops)
        ax01 = sns.boxplot(ax=axes[0, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dt_seg", showfliers=showfliers, boxprops=boxprops)
        ax02 = sns.boxplot(ax=axes[0, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dt_net", showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dt_conv", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax00)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dt_seg", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax01)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dt_net", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax02)

        ax10 = sns.boxplot(ax=axes[1, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Fp_conv", showfliers=showfliers, boxprops=boxprops)
        ax11 = sns.boxplot(ax=axes[1, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Fp_seg", showfliers=showfliers, boxprops=boxprops)
        ax12 = sns.boxplot(ax=axes[1, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Fp_net", showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Fp_conv", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax10)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Fp_seg", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax11)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Fp_net", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax12)

        ax20 = sns.boxplot(ax=axes[2, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dp_conv", showfliers=showfliers, boxprops=boxprops)
        ax21 = sns.boxplot(ax=axes[2, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dp_seg", showfliers=showfliers, boxprops=boxprops)
        ax22 = sns.boxplot(ax=axes[2, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dp_net", showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dp_conv", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax20)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dp_seg", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax21)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="Dp_net", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax22)
    ...
    def boxplot_adc_hpv(self):
        ...
        ax = sns.boxplot(ax=ax, data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="ADC",  showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="HPV", y="ADC", color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax)
    ...
    def boxplot_ivim_n_only_in_tnm(self):
        ...
        ax00 = sns.boxplot(ax=axes[0, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_conv", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax01 = sns.boxplot(ax=axes[0, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_seg", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax02 = sns.boxplot(ax=axes[0, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_net", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_conv", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax00)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_seg", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax01)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dt_net", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax02)

        ax10 = sns.boxplot(ax=axes[1, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_conv", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax11 = sns.boxplot(ax=axes[1, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_seg", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax12 = sns.boxplot(ax=axes[1, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_net", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_conv", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax10)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_seg", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax11)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Fp_net", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax12)

        ax20 = sns.boxplot(ax=axes[2, 0], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_conv", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax21 = sns.boxplot(ax=axes[2, 1], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_seg", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        ax22 = sns.boxplot(ax=axes[2, 2], data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_net", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_conv", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax20)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_seg", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax21)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="Dp_net", order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax22)
    ...
    def boxplot_adc_n_only_in_tnm(self):
        ...
        ax = sns.boxplot(ax=ax, data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="ADC", order=['N0', 'N1', 'N2'], showfliers=showfliers, boxprops=boxprops)
        sns.stripplot(data=self.df_tot.query(f"GTV_name == 'GTVp'"), x="N", y="ADC",  order=['N0', 'N1', 'N2'], color=color_strip, dodge=True, alpha=alpha, jitter=jitter, legend=None, ax=ax)
