...
def fit_least_squares_array(bvalues, dw_data, mask_data, fitS0=True, bounds=([0.8, 0, 0, 0.005], [1.2, 0.005, 0.7, 0.2]), cutoff=200): # bounds=([0.9, 0.0001, 0.0, 0.0025], [1.1, 0.0025, 0.2, 0.2])
    """
...
def fit_least_squares(bvalues, dw_data, IR=True, S0_output=True, fitS0=True,
